...
export default function EmiCalculatorPageClient({
  badge = 'Smart Financial Tools',
  title,
  subtitle = 'Calculate monthly installments, check total interest payable, generate reducing vs flat rate schedules, and evaluate your loan eligibility instantly.',
  defaultAmount,
  defaultRate,
  defaultTenure,
  defaultTenureType,
        ...
        <div className="container" style={{ maxWidth: '1200px' }}>
          <div style={{
            ...
            <EmiCalculator 
              ...
              defaultTenureType={defaultTenureType}
            />
          </div>
        </div>
      </section>

      {/* Dynamic SEO Article / Guide Section */}
      {children ? (
        children
      ) : (
