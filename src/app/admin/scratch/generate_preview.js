...
const reason = 'The uploaded identity proof document is blurry. Please upload a clear photo of your PAN card.';
    ...
    <tr>
      <td align="center" style="padding:40px 10px;">
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" class="email-container" style="max-width:560px;background:#0d1627;border:1px solid #1a2744;border-radius:20px;overflow:hidden;">
          ...
          <!-- Gradient Top Bar (Amber/Red alert) -->
          <tr>
          ...
          <tr>
            <td class="card-body" style="padding:44px 40px;">
              <table border="0" cellpadding="0" cellspacing="0" width="100%">
                ...
                <!-- Icon Badge (Alert Exclamation Triangle) -->
                <tr>
                  <td align="center" style="padding-bottom:28px;">
...
fs.writeFileSync('S:/calculator/loan-checker/public/approval_preview.html', approvalHtml, 'utf8');
fs.writeFileSync('S:/calculator/loan-checker/public/rejection_preview.html', rejectionHtml, 'utf8');
console.log('Successfully updated static HTML preview files!');
